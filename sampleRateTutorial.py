...
# Author: dafernan
# Copyright: Tutorial_two_3
# Description: https://wiki.gnuradio.org/index.php/Sample_Rate_Tutorial
...
class sampleRateTutorial(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sample Rate Tutorial")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sample Rate Tutorial")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sampleRateTutorial")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(0.5*freq, 20*freq, 200, 5*freq, 200)
...
def main(top_block_cls=sampleRateTutorial, options=None):
