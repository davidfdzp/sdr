...
# Title: Mpsk Stage4
# Generated: Fri Jan 10 18:58:47 2020
##################################################
...
class mpsk_stage4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b(list(ord(i) for i in 'The quick brown fox 0123456789...'), True, 1, [])
...
def main(top_block_cls=mpsk_stage4, options=None):
