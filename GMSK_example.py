...
class GMSK_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GMSK_example")
        ...
        self.fsk_deviation_hz = fsk_deviation_hz = 8.0*samp_rate/(2*math.pi)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_fsk_deviation_hz(8.0*self.samp_rate/(2*math.pi))
...
def main(top_block_cls=GMSK_example, options=None):
