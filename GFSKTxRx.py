...
class GFSKTxRx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSKTxRx")
        ...
        # Blocks
        ##################################################
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_char*1, baud_rate,True)
...
def main(top_block_cls=GFSKTxRx, options=None):
