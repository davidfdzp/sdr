...
class OnOffKeying(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, modulating_freq, 1, 0, 0)
    ...
    def set_modulating_freq(self, modulating_freq):
        ...
        self.analog_sig_source_x_1.set_frequency(self.modulating_freq)
